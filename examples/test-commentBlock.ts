 ...
 * @return {number} the number of the beast
 */
 ...
 * @param a {string} - A string that is 'a'
 * @param b {string} - A string that is b-like
 * @param c {number} - A number to see
 *
 */
export function withParams(a, b, c) {
 ...
 * @param c {number} - A number to see
 */
export function typeParamsWin(a:number, // typescript says this is a number
                              b:any, // typescript says this is any
                              c // typescript assigned no further type
):any { // typescript defined return
 ...
 *
 * {{{jsdoc tag="see"}}} https://www.tremho.com
 *
 * {{{text}}}
